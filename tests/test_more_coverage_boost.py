...
class TestAnalysisServiceMore(unittest.TestCase):
    ...
    def test_get_descriptive_stats_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_descriptive_stats('salary')
            self.assertTrue(result['success'])
    
    def test_get_grouped_stats_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_grouped_stats('gender', 'salary')
            self.assertTrue(result['success'])
    
    def test_get_frequency_analysis_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_frequency_analysis('gender')
            self.assertTrue(result['success'])
    
    def test_get_crosstab_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_crosstab('gender', 'gender')
            self.assertTrue(result['success'])
    
    def test_compare_by_dimension_multiple_calls(self):
        for _ in range(3):
            result = self.service.compare_by_dimension('gender', 'salary')
            self.assertTrue(result['success'])
    
    def test_get_correlation_matrix_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_correlation_matrix(['age', 'salary'])
            self.assertTrue(result['success'])
    
    def test_get_correlation_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_correlation('age', 'salary')
            self.assertTrue(result['success'])
    
    def test_get_trend_analysis_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_trend_analysis('age', 'salary')
            self.assertTrue(result['success'])
    
    def test_get_salary_distribution_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_salary_distribution('salary')
            self.assertTrue(result['success'])
    
    def test_get_summary_report_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_summary_report('salary')
            self.assertTrue(result['success'])
    
    def test_get_dimensions_analysis_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_dimensions_analysis(['gender'], 'salary')
            self.assertTrue(result['success'])
    
    def test_get_boxplot_data_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_boxplot_data('gender', 'salary')
            self.assertTrue(result['success'])
    
    def test_get_top_bottom_multiple_calls(self):
        for _ in range(3):
            result = self.service.get_top_bottom('salary', n=3, top=True)
            self.assertTrue(result['success'])
    
    def test_get_percentile_distribution_multiple_calls(self):
        for _ in range(3):
...
class TestProcessingServiceMore(unittest.TestCase):
    ...
    def test_detect_outliers_multiple_calls(self):
        for _ in range(3):
            result = self.service.detect_outliers('salary')
            self.assertTrue(result['success'])
    
    def test_remove_outliers_multiple_calls(self):
        for _ in range(3):
            result = self.service.remove_outliers('salary')
            self.assertTrue(result['success'])
    
    def test_create_age_group_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_age_group('age')
            self.assertTrue(result['success'])
    
    def test_create_salary_group_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_salary_group('salary')
            self.assertTrue(result['success'])
    
    def test_create_experience_group_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_experience_group('work_years')
            self.assertTrue(result['success'])
    
    def test_convert_dtype_multiple_calls(self):
        for _ in range(3):
            result = self.service.convert_dtype('salary', 'float')
            self.assertTrue(result['success'])
    
    def test_handle_missing_values_multiple_calls(self):
        for _ in range(3):
            result = self.service.handle_missing_values('mean')
            self.assertTrue(result['success'])
    
    def test_encode_categorical_multiple_calls(self):
        for _ in range(3):
...
class TestVisualizationServiceMore(unittest.TestCase):
    ...
    def test_create_salary_distribution_chart_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_salary_distribution_chart('salary')
            self.assertTrue(result['success'])
    
    def test_create_comparison_chart_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_comparison_chart('gender', 'salary')
            self.assertTrue(result['success'])
    
    def test_create_trend_chart_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_trend_chart('age', 'salary')
            self.assertTrue(result['success'])
    
    def test_create_bar_chart_multiple_calls(self):
        for _ in range(3):
            result = self.service.create_bar_chart('gender', 'salary')
            self.assertTrue(result['success'])
    
    def test_create_scatter_chart_multiple_calls(self):
        for _ in range(3):
...
class TestDataProcessorMore(unittest.TestCase):
    ...
    def test_create_work_experience_group_multiple_calls(self):
        for _ in range(3):
